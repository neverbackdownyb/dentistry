...
<body class="skin-blue sidebar-mini" data-reset-height="false">
<div class="wrapper">
    <!-- Main Header -->
    <header class="main-header">
        ...
        <a href="" class="logo">
            ...
            <span class="logo-lg">{!! config('app.name') !!} CMS</span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <?php
                                $user_name = $uauth['name']??'N/A';
                                $user_avatar = $uauth['avatar']??'http://infyom.com/images/logo/blue_logo_150x150.jpg';
                            ?>
